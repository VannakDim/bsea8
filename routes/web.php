...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin'], 'as' => 'admin.'], function () {
    ...
    Route::get('/get-advertisements', ['as' => 'getAdvertisementsRoute', 'uses' => 'AdvertisementController@get']);
    Route::get('/advertisements/published/{id}', ['as' => 'publishedAdvertisementsRoute', 'uses' => 'AdvertisementController@published']);
    Route::get('/advertisements/unpublished/{id}', ['as' => 'unpublishedAdvertisementsRoute', 'uses' => 'AdvertisementController@unpublished']);
    /*** For Banner ***/
    Route::resource('banners', 'BannerController');
    Route::get('/get-banners', ['as' => 'getBannersRoute', 'uses' => 'BannerController@get']);
    Route::get('/banners/published/{id}', ['as' => 'publishedBannersRoute', 'uses' => 'BannerController@published']);
    Route::get('/banners/unpublished/{id}', ['as' => 'unpublishedBannersRoute', 'uses' => 'BannerController@unpublished']);
});
