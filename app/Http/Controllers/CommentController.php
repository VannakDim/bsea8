...
class CommentController extends Controller {
	...
	public function get() {
		...
		return datatables()->of($comments)
            ...
            ->editColumn('post_title', function($comments){
                return Str::limit($comments->comment, 30);
            })
			->addColumn('post', function ($comments) {
				return '<a class="post-view-button" role="button" tabindex="0" data-id="' . $comments->post->id . '">' . Str::limit($comments->post->post_title, 30) . '</a>';})
